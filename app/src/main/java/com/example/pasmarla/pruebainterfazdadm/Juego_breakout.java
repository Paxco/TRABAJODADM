...
public class Juego_breakout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_breakout);
    ...
    class BreakoutView extends SurfaceView implements Runnable {
        ...
        final int dificultad=preferencias.getInt("id2", position2);
        ...
        public void createBricksAndRestart(){
            ...
            columna=16-dificultad;
            fila=8-dificultad;
            int brickWidth = screenX / columna;
            int brickHeight = screenY / (fila*2);
